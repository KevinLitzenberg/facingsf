    ...
    <!--Loads the element that will finally hold the row of three -->
        ...
        <div id="image_stack01">
				...
				<?php
					...
					//Run a query
					//$resultSF = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'San Francisco, CA' AND YEAR(`ImageDate`)= '2012' AND `Notes`='splash' ORDER BY `ImageDate` DESC LIMIT 3");
					$resultSF = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'San Francisco, CA' AND YEAR(`ImageDate`)= '2012' AND `Notes` = 'splash' AND `Notes` != 'SIGNS and NOTES' ORDER BY `ImageDate` DESC LIMIT 3");
					

					//Photo1
					$row = mysql_fetch_row($resultSF);
		...
		<div id="image_stack02">
			<a href=DisplayPhotoGallery01.html.php?City=SanFran&Year=2011>
				...
				<?php
					...
					//Run a query
					$resultSF = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'San Francisco, CA' AND YEAR(`ImageDate`)= '2011' AND `Notes`='splash' ORDER BY `ImageDate` DESC LIMIT 3");
		...
		<a href=DisplayPhotoGallery01.html.php?City=SanFran&Year=2010>
		    <?php
				...
				//Run a query
				$resultSF = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'San Francisco, CA' AND YEAR(`ImageDate`)= '2010' AND `Notes`='splash' ORDER BY `ImageDate` DESC LIMIT 3");
	    ...
	    <div id="image_stack04">
	        <a href=DisplayPhotoGallery01.html.php?City=LosAngeles&Year=2010>
			    <?php
					...
					//Run a query
				   $resultLA = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'Los Angeles, CA' AND YEAR(`ImageDate`)= '2010' AND `Notes`='splash' ORDER BY `ImageDate` ASC LIMIT 3");

					//Photo1
					$row = mysql_fetch_row($resultLA);
        ...
        <div id="image_stack05">
            <a href=DisplayPhotoGallery01.html.php?City=NewYork&Year=2010>
			    <?php
					...
					//Run a query
					$resultNY = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'New York, NY' AND YEAR(`ImageDate`)= '2010' AND `Notes`='splash' ORDER BY `ImageDate` ASC LIMIT 3");
					
					//Photo1
					$row = mysql_fetch_row($resultNY);
        ...
        <div id="image_stack06">
            <a href=DisplayPhotoGallery01.html.php?City=SoutheastAsia&Year=2008>
			    <?php
					...
					//Run a query
					//$resultSEastAsia = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'Bangkok, Thailand' OR 'Chang Mai, Thailand' OR 'Pantang, Malaysia' OR 'Kula Lumpar, Malaysia' OR 'Singapore, Singapore' AND `Notes`='splash' ORDER BY `ImageDate` DESC LIMIT 3");
					$resultSEastAsia = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'Bangkok, Thailand' AND `Notes`='splash' OR `ImageLocation` = 'Chang Mai, Thailand' AND `Notes`='splash' OR `ImageLocation` = 'Pantang, Malaysia' AND `Notes`='splash' OR `ImageLocation` = 'Kula Lumpar, Malaysia' AND `Notes`='splash' OR `ImageLocation` = 'Singapore, Singapore' AND `Notes`='splash' ORDER BY `ImageDate` DESC LIMIT 3");
					
					//Photo1
					$row = mysql_fetch_row($resultSEastAsia);
	 ...
	 <div id="image_stack07">
				...
				<?php
					...
					//Run a query
					//$resultCTA = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` LIKE '%Nicaragua' AND `Notes`='splash' OR `ImageLocation` LIKE '%Mexico' AND `Notes`='splash' ORDER BY `ImageDate` ASC LIMIT 3");
                    $resultCTA = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` LIKE '%Nicaragua' AND `Notes`='splash' AND `Notes` != 'SIGNS and NOTES' OR`ImageLocation` LIKE '%Mexico'AND `Notes`='splash' AND `Notes` != 'SIGNS and NOTES' ORDER BY `ImageDate` ASC LIMIT 3");

					//Photo1
					$row = mysql_fetch_row($resultCTA);
		...
		<div id="image_stack08">
			<a href=DisplayPhotoGallery01.html.php?City=BarcelonaSpain&Year=2006>
			    <?php
					...
					//Run a query
					$resultSpain = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'Barcelona, Spain' AND `Notes`='splash' ORDER BY `ImageDate` DESC LIMIT 3");

					//Photo1
					$row = mysql_fetch_row($resultSpain);
        ...
        <div id="image_stack09">
		    ...
		    <?php
				...
				//Run a query
				$resultFrance = mysql_query("SELECT * FROM faceimages WHERE `ImageLocation` = 'Paris, France' LIMIT 3");
					
				//Photo1
				$row = mysql_fetch_row($resultFrance);
